...
for i=1:length((time_ta(:,1)))
    ...
    plot(log(time_ta(i,:)),'DisplayName','AVTA','LineWidth',1.5)
    plot(log(time_scale_ta(i,:)),'DisplayName','AVTA+','LineWidth',1.5)  
    plot(log(time_qh(i,:)),'DisplayName','Quick Hull','LineWidth',1.5)  ;
